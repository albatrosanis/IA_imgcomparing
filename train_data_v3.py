...
# Ensure correct multiprocessing context for Windows
...
def train_autoencoder(model, dataloader, optimizer, criterion, total_epochs, start_epoch=0):
    ...
    for epoch in range(start_epoch, total_epochs):
        ...
        # Save model checkpoint with a unique name for each epoch
        checkpoint_path_epoch = f'autoencoder_checkpoint_epoch_{epoch + 1}.pth'
        torch.save({
            'epoch': epoch,
        ...
        print(f"Checkpoint saved: {checkpoint_path_epoch}")
